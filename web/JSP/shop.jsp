...
<html lang="en">
    ...
    <body id="shop-container">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav shop-navbar">
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="home"><img src="images/logobia.jpg" class="logo" alt=""></a>
                    </div>
                                ...
                                <div class="col-12 col-sm-8 text-center text-sm-left">
                                    <div class="search-product">
                                        <form action="home" method="get">
                                            <input class="form-control" placeholder="Search here..." type="text" name="pname">
                                                ...
                                                <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                                    <div class="products-single fix">
                                                        <div class="box-img-hover">
                                                            <img src="products/${product.image}" class="img-fluid" alt="Image">
                                                            <div class="mask-icon">
                                                                <ul>
                                                                    <li><a href="detail?pid=${product.pid}" target="_blank" data-toggle="tooltip" data-placement="right" title="View"><i class="fas fa-eye"></i></a></li>
                                                                </ul>
                                                                <c:choose>
                                                                    <c:when test="${sessionScope.user == null || sessionScope.pass == null}">
                        ...
                        <div class="product-categori">
                            ...
                            <div class="filter-sidebar-left">
                                ...
                                <div class="list-group list-group-collapse list-group-sm list-group-tree" id="list-group-men" data-children=".sub-men">
                                    ...
                                    <a href="home?catid=cat1" class="list-group-item list-group-item-action" onclick="activeCategory(this)" value="Literature"> Carom </a>
                                    <a href="home?catid=cat2" class="list-group-item list-group-item-action" onclick="activeCategory(this)" value="Mystery"> Libre </a>
                                    <a href="home?catid=cat3" class="list-group-item list-group-item-action" onclick="activeCategory(this)" value="Romance"> Custom </a>
                                </div>
                            </div>
                        </div>
                        <div class="filter-sidebar-left">
        ...
        <div class="footer-copyright">
            <p class="footer-company">2024 &copy; by <a href="#" target="_blank">Pham Thi Phuong Anh</a> - PRJ301
        </div>
        <!-- End copyright  -->
